...
$objConnect->set_charset('utf8');
	...
	$objQuery = $objConnect->query("UPDATE user_status SET Repo = 'yes' WHERE username = '$user'");
	$objQuery = $objConnect->query("UPDATE user_status SET Textpo = '$Text' WHERE username = '$user'");
