    ...
    <div class="panel-heading">
	  ...
	  $i = 1;
          ...
          <input type="checkbox" name="chkagreement" onClick="apply();"><font style="font-weight:bold"> ยอมรับเงื่อนไข </font><a data-toggle="modal" data-target="#Warning" href="#" style="font-weight:bold"><font color="#FF0000">**กรุณาอ่านก่อนอัพโหลดไฟล์**</font></a><br>
            ...
            <button id="btnPEDSubmit" class="col-lg-offset-5 btn btn-success" type="button" disabled onClick='PDFUploadPlan();'><i class="fa fa-upload">&nbsp;&nbsp;อัพโหลด</i></button>
            <br><br>
            </form>
          <?php }else{  } 
...
<script src="assets/js/Upload_Plan.js"></script>
<script language=javascript>
function apply()
{
  document.frm.btnPEDSubmit.disabled=true;
  if(document.frm.chkagreement.checked==true)
  {
    document.frm.btnPEDSubmit.disabled=false;
  }
  if(document.frm.chkagreement.checked==false)
  {
    document.frm.btnPEDSubmit.enabled=false;
  }
}
</script>
