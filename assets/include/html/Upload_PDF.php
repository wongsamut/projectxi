    ...
    <div class="panel-heading">
       ...
       ?>
          <table class="table table-striped">
            <tr class="info" style="cursor:context-menu">
              ...
              <th><center><font color="#000000">แผนกแบบแผน</font></center></th>
              <th><center><font color="#000000">แผนกพัสดุ</font></center></th>
              <th><center><font color="#000000">แผนกการเงิน</font></center></th> 
            </tr>
	  ...
	  $i = 1;
          ...
          <input type="checkbox" name="chkagreement" onClick="apply();"><font style="font-weight:bold"> ยอมรับเงื่อนไข </font><a data-toggle="modal" data-target="#Warning" href="#" style="font-weight:bold"><font color="#FF0000">**กรุณาอ่านก่อนอัพโหลดไฟล์**</font></a><br>
            ...
            <button id="btnPDFSubmit" type="button" class="col-lg-offset-5 btn btn-success" disabled onClick='PDFUpload();'><i class="fa fa-upload">&nbsp;&nbsp;อัพโหลด</i></button>
            <br><br>
            </form>
          <?php }else{  } 
...
function apply()
{
  document.frm.btnPDFSubmit.disabled=true;
  if(document.frm.chkagreement.checked==true)
  {
    document.frm.btnPDFSubmit.disabled=false;
  }
  if(document.frm.chkagreement.checked==false)
  {
    document.frm.btnPDFSubmit.enabled=false;
  }
}
</script>
