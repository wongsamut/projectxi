...
<div class="container">
  <div class="panel panel-warning">
    <div class="panel-heading">
      <h1 class="panel-title" style="font-size: 35px;"><i style="font-size: 25px;" class="fa fa-inbox"></i>
        เอกสารที่รอพิจารณา
        </h1>
      </div>
      ...
      $objQuery = mysqli_query($objConnect, "select * from docme Where Status_Plan = 'yes' and Status_Supp = 'No' or Status_Supp = 'Wait'");
       ...
       ?>
          <table class="table table-bordered table-hover table-striped" style="border-collapse:inherit;">
            <tr class="info" style="cursor:context-menu">
              ...
              <th><center><span style="font-weight:bold"><font color="#000000">ดำเนินการซื้อของ</font></span></center></th>
              <th><center><span style="font-weight:bold"><font color="#000000">จัดซื้อสินค้าเรียบร้อย</font></span></center></th>
              <th><center><span style="font-weight:bold"><font color="#000000">ไม่สามารถจัดซื้อได้</font></span></center></th>
	  ...
	  $i = 1;
            ...
            <tbody style="cursor:context-menu">
              ...
              <td><center><button id="btnbuypass" onclick="btnbuy(this);" value="<?= $objResult['Doc_Budget'] ?>" type="button" class="btn btn-warning"><i class="fa fa-shopping-cart"></i></button></center></td>
              <td><center><button id="btnsuppass" onclick="btnsuppass(this);" value="<?= $objResult['Doc_Budget'] ?>" type="button" class="btn btn-success"><i class="fa fa-check"></i></button></center></td>
              <td><center><button id="btnsupfail" onclick="btnsupfail(this);" value="<?= $objResult['Doc_Budget'] ?>" type="button" class="btn btn-danger"><i class="fa fa-times"></i></button></center></td>
